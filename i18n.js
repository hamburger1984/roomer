...
const TRANSLATIONS = {
  en: {
    ...
    measure: {
      ...
      instructions:
        "Pick a type, then click two points on the plan to add a measurement. Click an existing measurement to edit or delete it.",
      exit: "Done",
      exportImage: "Export PNG",
      clearAll: "Clear All",
      scaleLabel: "Scale (px per 1 m)",
      typeGroup: "Measurement Types",
      legendTitle: "Legend",
      legendUnit: "All lengths in centimeters (cm)",
      noMeasurements: "No measurements yet.",
      valueLabel: "Length (cm)",
      setAsScale: "Use as scale",
      delete: "Delete",
      firstPoint: "Click the first point…",
      readyForSecond: "Click the second point. (Esc = cancel)",
      wall: "Room width / wall length",
      door: "Door width",
      doorOffset: "Wall → door frame",
      window: "Window width",
      windowOffset: "Wall → window",
      chimney: "Chimney (distance from wall)",
      column: "Column / pillar",
      height: "Room height",
      other: "Other",
      noDataToExport:
        "Export requires at least one measurement or a floor plan.",
      deleteConfirm: "Delete this measurement?",
      clearAllConfirm: "Delete all measurements?",
      obstacleTitle: "Fixed installations (limit usable space)",
      addObstacle: "Add fixed installation",
      obstacleTypeGroup: "Fixed installation types",
      obstacleFirstCorner: "Click the first corner of the fixed installation…",
      obstacleSecondCorner:
        "Click the opposite corner to finish. (Esc = cancel)",
      obstacleDeleteConfirm: "Delete this fixed installation?",
      obstacleClearConfirm: "Delete all fixed installations?",
      obstacleWidth: "Width (cm)",
      obstacleDepth: "Depth (cm)",
      obstacleName: "Name",
      // Obstacle types
  ...
  de: {
    ...
    aria: {
      ...
      measureTool: "Maßwerkzeug",
    },

    measure: {
      title: "Maßwerkzeug",
      instructions:
        "Typ wählen, dann zwei Punkte auf dem Plan klicken. Klicken Sie auf ein vorhandenes Maß, um es zu bearbeiten oder zu löschen.",
      exit: "Fertig",
      exportImage: "PNG exportieren",
      clearAll: "Alles löschen",
      scaleLabel: "Maßstab (px pro 1 m)",
      typeGroup: "Maßtypen",
      legendTitle: "Legende",
      legendUnit: "Alle Längen in Zentimetern (cm)",
      noMeasurements: "Noch keine Maße vorhanden.",
      valueLabel: "Länge (cm)",
      setAsScale: "Als Maßstab verwenden",
      delete: "Löschen",
      firstPoint: "Ersten Punkt klicken…",
      readyForSecond: "Zweiten Punkt klicken. (Esc = abbrechen)",
      wall: "Raumbreite / Wandlänge",
      door: "Türbreite",
      doorOffset: "Wand → Türzarge",
      window: "Fensterbreite",
      windowOffset: "Wand → Fenster",
      chimney: "Kamin (Abstand zur Wand)",
      column: "Stütze / Pfeiler",
      height: "Raumhöhe",
      other: "Sonstiges",
      noDataToExport:
        "Für den Export wird mindestens ein Maß oder ein Grundriss benötigt.",
      deleteConfirm: "Dieses Maß löschen?",
      clearAllConfirm: "Alle Maße löschen?",
      obstacleTitle: "Feste Einbauten (schränken Nutzfläche ein)",
      addObstacle: "Feste Installation hinzufügen",
      obstacleTypeGroup: "Typen fester Installationen",
      obstacleFirstCorner: "Erste Ecke der festen Installation klicken…",
      obstacleSecondCorner:
        "Gegenüberliegende Ecke klicken. (Esc = abbrechen)",
      obstacleDeleteConfirm: "Diese feste Installation löschen?",
      obstacleClearConfirm: "Alle festen Installationen löschen?",
      obstacleWidth: "Breite (cm)",
      obstacleDepth: "Tiefe (cm)",
      obstacleName: "Name",
      // Obstacle types
      heater: "Heizkörper / Radiator",
      appliance: "Fest installiertes Gerät",
